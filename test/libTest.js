...
describe("head", () => {
  ...
  describe("-c 10 fifteenLines.txt", () => {
    it("should return first 10 chars", () => {
  ...
  describe("fiveLines.txt badfile.txt", () => {
  ...
  describe("fiveLines.txt badfile.txt tenLines.txt", () => {
